...
\begin{figure}
    \begin{center}
        \begin{tikzpicture}
            ...
            %output layer
            \node[circle, draw, minimum size=1cm] (sigma) at (6, 2.25) {};
...
made of respectively 32 and 16 neurons and an output layer with a single neuron.
Before reaching these layers, the information travels across two layers with specific functions.
The input images, containing data organized in two dimensions, are provided to the input layer which is chosen
between to specific types with ability of standardize the data.
A standardization of some data is achieved substracting to each of the values the mean va
