...
\begin{figure}
    \begin{center}
        \begin{tikzpicture}
            ...
            \draw[red, fill=red] (-6.2, 0.2) circle [radius=0.4mm] {};
            \draw[red, fill=red] (-5.3, 0.5) circle [radius=0.4mm] {};
            \draw[red, fill=red] (-4.7, 1.3) circle [radius=0.4mm] {};
            \draw[red, fill=red] (-4.4, 1.8) circle [radius=0.4mm] {};
            \draw[red, fill=red] (-3.7, 2.4) circle [radius=0.4mm] {};
            \begin{scope}[shift={(-6.7,0)}]
                \draw[domain=0:3.3, smooth, variable=\x, black]  plot ({\x}, {0.65*\x});
            \end{scope}

            \draw[->] (-2, 0) -- (2, 0) node[below] {$x$};
            \draw[->] (-1.7, -0.3) -- (-1.7, 3) node[left] {$f(x)$};
            \draw[red, fill=red] (-1.2, 0.2) circle [radius=0.4mm] {};
            \draw[red, fill=red] (-0.3, 0.5) circle [radius=0.4mm] {};
            \draw[red, fill=red] (0.3, 1.3) circle [radius=0.4mm] {};
            \draw[red, fill=red] (0.6, 1.8) circle [radius=0.4mm] {};
            \draw[red, fill=red] (1.3, 2.4) circle [radius=0.4mm] {};
            ...
            \draw[red, fill=red] (3.8, 0.2) circle [radius=0.4mm] {};
            \draw[red, fill=red] (4.7, 0.5) circle [radius=0.4mm] {};
            \draw[red, fill=red] (5.3, 1.3) circle [radius=0.4mm] {};
            \draw[red, fill=red] (5.6, 1.8) circle [radius=0.4mm] {};
            \draw[red, fill=red] (6.3, 2.4) circle [radius=0.4mm] {};
