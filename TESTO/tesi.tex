...
\begin{abstract}
    ...
    Two are today's leading approaches used to interpret these images and characterise protoplanetary 
     and their embedded planets:
      ...
      employment of numerical simulation to reproduce,  from starting assumptions,
        synthetic observations that are then compared with  observations  directly  in  the  data  space.   
    ...
    We collated synthetic images obtained from numerical simulations implementing
     a dataset aimed at this purpose which was made publicly available through GitHub
      ...
      planet and that led to the formation of a gap.
       ...
       obtaining a trained model that, on a test set of about 200 images, predicted the planet mass with 
       relative absolute error of () and a mean squared error of ()  which was assumed as the prediction uncertainty
        of the model.
        Finally, we applied the trained model to the real observation of DS Tau disc predicting a mass of 
        for the embedded planet, in fair agreement with the mass of () established in a previous study.
\end{abstract}
...
\begin{figure}
    \begin{center}
        \scalebox{0.85}{\input{images/corr&err8.pgf}}
    \end{center}
